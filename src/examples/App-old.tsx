    ...
    render() {
        return (
            ...
            `
                    ...
                    <CarvedCard>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellendus, sapiente natus. Sed tenetur atque numquam. Voluptatem explicabo, laudantium deleniti ad tempora voluptatum at accusamus harum exercitationem quam quisquam, illum totam.</p>
                    </CarvedCard>
                    ...
                    <div style={{ height: '500px', overflow: 'hidden', boxSizing: 'border-box' }}>
                        <CarvedKarst>
                            <CarvedButton text="Submit"></CarvedButton>
                            <CarvedButton text="Cancel" stratum={{ marginLeft: 30 }}></CarvedButton>
